...
<?php
  ...
  // Listado /////////////////////////////////////////////////i
  $resu= $db->query("SELECT dni, nombre, direccion, telefono FROM cliente");
  ?>
...
<table class="table table-striped">
  ...
  <?php
      ...
      <tr>
		...
		<td>
			<form action="pagina.php" method="post">
				<input type="hidden" name="ejercicio" value="01"> <input
	...
	<form action="pagina.php" method="post">
		<input type="hidden" name="ejercicio" value="01"> <input type="hidden"
